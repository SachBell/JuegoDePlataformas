...
class Personaje:
    def __init__(self, x, y):
        self.Sprites_Idle = [pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Idle.png')]

        self.Sprites_Caminando_Izquierda = [pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Left_1.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Left_2.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Left_3.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Left_4.png')]
        
        self.Sprites_Caminando_Derecha = [pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Right_1.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Right_2.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Right_3.png'),
                                          pygame.image.load('./PROYECTOS/Juegodeplataformas/Data/Sprites/Stickman/Stickman_Walk_Right_4.png')]
